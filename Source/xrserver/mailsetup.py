...
from  config import  smtp_email_value,smtp_from_name_value,smtp_host_value,smtp_password_value,smtp_port_value,front_base_url_value
import codecs
...
def email_send(email, choice, firstname=None,token=None, sessionid=None):
    ...
    s = smtplib.SMTP(host=str(smtp_host_value),port= str(smtp_port_value))
    print('sending...')
    s.starttls()
    # s.login('support@hudle.io', 'Rein1234#')
    s.login(smtp_email_value,smtp_password_value)
...
<body
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse;">
                                                                <td class="es-m-p0l" align="center"
                                                                    ...
                                                                    <a href="{front_base_url_value}" target=""
    ...
    # Mail invitation to the event from Host to users 
        ...
        link = front_base_url_value+'/login'
        msg.set_content(
            f"""\
