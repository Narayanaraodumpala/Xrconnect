...
@mod_content.route('/getEnvList', methods=('GET', 'POST', 'PUT'))
def getEnvList():
...
@mod_content.route('/getEnvpaginationlist',methods=('GET','POST'))
...
@mod_content.route('/getAppList', methods=('GET', 'POST', 'PUT'))
def getAppList():
    if request.method == 'GET':        
        data = getList('2')
        print('Received data')
...
@mod_content.route('/getApppaginationlist',methods=('GET','POST'))
...
@mod_content.route('/getCatalogList', methods=('GET', 'POST', 'PUT'))
def getCatalogList():
    if request.method == 'GET':
        data = getList('0')
        print('Received data')
...
def azurecontent():
    if request.method == 'POST':
        try :
            ...
            description= request.form['Description']
            owner = request.form['Owner']
            thumbnail_path = request.form['AZthumbFileUpload']
            accesstype  = request.form['AccessType']
            version = request.form['Version']
